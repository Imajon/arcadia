...
// Resolve public folder — works regardless of where you run node from
const publicDir = path.join(__dirname, 'public');
if (!fs.existsSync(publicDir)) {
  console.error(`\n❌ Dossier "public" introuvable : ${publicDir}`);
  console.error('   Assure-toi de lancer "node server.js" depuis le dossier webvr-tag/\n');
  process.exit(1);
}
...
// Fallback: only for extensionless routes (SPA), never for .js/.css etc.
